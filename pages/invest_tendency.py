...
st.title("FIND Investor Tendency")
st.info("Decode your investment preferences into 4-letter codes derived from the latest investment data and visualize them. Discover your investment personality effortlessly through our service and tailor your investment strategies accordingly.", icon="📃")
...
if st.button("What TENDENCY do the investor have?") or input_user_name:
